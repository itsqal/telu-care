            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700 leading-5 dark:text-gray-400">
                        ...
                        <span class="font-medium text-xs">{{ $paginator->firstItem() }}</span>
                        <span>{!! __('sampai') !!}</span>
                        <span class="font-medium text-xs">{{ $paginator->lastItem() }}</span>
                        <span>{!! __('dari') !!}</span>
                        <span class="font-medium text-xs">{{ $paginator->total() }}</span>
                        <span>{!! __('hasil') !!}</span>
                    </p>
                </div>
